// Simple static server to preview Caja/panel.html
const http = require('http');
const fs = require('fs');
const path = require('path');

const PORT = process.env.PORT ? parseInt(process.env.PORT, 10) : 5512;
const ROOT = path.join(process.cwd(), 'Caja');
...
server.listen(PORT, () => {
  console.log(`Panel preview server running: http://localhost:${PORT}/panel.html`);
});
