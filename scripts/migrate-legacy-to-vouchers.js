...
// Abrir base SQLite unificada
const db = new Database('C:\\appCasino\\data\\casino.db');

// Asegurar llaves foráneas activas
db.exec('PRAGMA foreign_keys = ON');

// Asegurar usuario LEGACY para cumplir FK en issued_by_user_id
db.prepare(
  "INSERT OR IGNORE INTO users (id, email, full_name, role, is_active) VALUES ('LEGACY', 'legacy@local', 'Legacy User', 'caja', 1)"
).run();

// Migrar tickets legacy a vouchers
