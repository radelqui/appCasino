# Paso 18: Crear archivos de documentación y README
import os

readme_md = '''# Sistema TITO para Casino
...
with open('tito-casino-system/README.md', 'w') as f:
    f.write(readme_md)
...
with open('tito-casino-system/jest.config.js', 'w') as f:
    f.write(jest_config_js)

# Crear archivo de setup para tests
test_setup_js = '''// tests/setup.js
...
with open('tito-casino-system/tests/setup.js', 'w') as f:
    f.write(test_setup_js)

print("✅ Documentación y configuración de tests creada")